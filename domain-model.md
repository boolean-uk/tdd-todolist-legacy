...
------- | ---------- | -------- | ----- | -------- | ------ | -------
TodoList | id @Int, items @Array | create(@String) | id increments, status starts off incomplete, adds item to array | | todo item | `create('hello') => {id: 1, text:
"hello", status: "incomplete" , date: "Tuesday"}`
...
| | | editText(@string) | get items, then update the text property of that item | updated TodoItem | `editText(1) => {id:1, text:"updated text, status: "incomplete", date: "Wednesday"}`
