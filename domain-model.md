...
-------------------- | -------------------- |-------------------------------------––––––––––––| --------------------------------------------------------------- | ------------------- | --------------------------------- | -------
TodoList             | create(@string)      |id @Int, text @String, status @String, date @Int | id increments, status starts off incomplete, adds item to array |item is created      | todo item                         | `create('hello') => {id: 1, text: "string", status: "incomplete", date: "2023-06-16"}`
...
itemByDay            |                      |day @Int month @Int year @Int                    | will find items for a certain day                               |array of items shown | item/items with same day          | `itemByDay(@Int,@Int,@Int) => [{id: 1, text: "string", status: "incomplete", date: "2023-06-16"}, {id: 2, text: "string", status: "incomplete", date: "2023-06-16"}]`
                     |                      |                                                 |                                                                 |no items on the day  | show an empty array               | `itemByDay(@Int,@Int,@Int) => []`
```