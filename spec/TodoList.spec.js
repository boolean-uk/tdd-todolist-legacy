...
describe('TodoList', () => {
  ...
  it('returning all shortens the description of long items', () => {
    const item1 = {
      id: 1,
    ...
    expect(todoList.findBy(1)).toEqual(item1)

    expect(todoList.showAll().filter((item) => item.text.length > 20)).toEqual([])
  })
